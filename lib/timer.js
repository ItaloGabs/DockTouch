...
export class TimerManager {
    ...
    get currentText() {
        if (this._timerRinging) return '0:00 - ACABOU!';
        if (this._timerActive) return this.timerText;
        if (this._alarmRinging) return `${this.alarmText} - HORÁRIO ATINGIDO!`;
        if (this._alarmActive) return this.alarmText;
        return 'Inativo';
    }
