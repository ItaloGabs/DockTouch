...
export class Dock {
    ...
    get _pinnedClipboardItems() { return this.extension._pinnedClipboardItems; }
    set _pinnedClipboardItems(val) { this.extension._pinnedClipboardItems = val; }
    ...
    _expand() {
        ...
        if (this._osdTimeoutId) {            GLib.source_remove(this._osdTimeoutId);
            this._osdTimeoutId = null;
        }
        this._osdContent.visible = false;
